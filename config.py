...
data_transform = {
    "train": transforms.Compose([
        ...
        transforms.RandomResizedCrop((32, 32), scale = (0.4, 1.0),ratio = (1.0, 1.0)),
...
# Weights path
WeightsPath = './models/weights_resnet18_50_6'
WeightsPath_LSTM = './models/weights_resnet_50_LSTM_4'
ResultsPath = './results/hist_resnet18_6_dropout.txt'
ResultsPath_LSTM = './results/hist_resnet_lstm_5.txt'
